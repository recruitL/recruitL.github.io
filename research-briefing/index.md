---
title: ChatGPT Research Briefing｜研究每日简报
lang: zh-CN
permalink: /research-briefing/
excerpt: ChatGPT 自动任务每天 09:00 推动的研究简报，独立于论文日报。
---

<section class="briefing-intro">
  <p>这里发布由 ChatGPT 自动任务推动、围绕当前研究主线整理的每日简报：优先保留真正值得跟进的论文、软件更新与会议动态，并给出“为什么相关”和下一步动作。</p>
  <p>已完整收录原 Research Briefing 自动任务自 2026-06-26 起的历史内容；后续简报继续按每日 09:00 更新。</p>
